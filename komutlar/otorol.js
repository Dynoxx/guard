...
exports.run = async (client, message, args) => {
  if (!message.member.hasPermission("MANAGE_ROLES"))
    return message.channel.send(
      "<a:Dynox_uyar:800419824538091610>  **Bu komutu kullanabilmek için gerekli yetkiye sahip değilsin** `Rolleri Yönet`"
    );
  ...
  if (args[0] === "ayarla") {
    ...
    return message.channel.send(
      new Discord.MessageEmbed()
        .setColor("0x36393E")
        .setDescription(
          "> **Otorol Sistemi Aktif edildi** <a:Dynox_tiks:798275047047168041> \n> **Sunucuya giren kişilere verilecek rol** <@&" +
            rol +
